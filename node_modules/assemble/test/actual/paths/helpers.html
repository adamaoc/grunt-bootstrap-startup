<!DOCTYPE html>
  ...
  <head>
    <meta charset="UTF-8">
    <title>Helpers and custom variables</title>
...
<link rel="stylesheet" href="../assets/css/css/bootstrap.css?v=1376618128257">
<link rel="stylesheet" href="../assets/css/css/responsive.css?v=1376618128257">
<link rel="stylesheet" href="../assets/css/css/main.css?v=1376618128257">


<h2>js helper</h2>
Example of using a custom "js" helper.
<script src="../assets/js/js/bootstrap.js?v=1376618128257"></script>
<script src="../assets/js/js/responsive.js?v=1376618128257"></script>
<script src="../assets/js/js/main.js?v=1376618128257"></script>
...
[ 'test/helpers/helper-*.js',
  ...
  dirname: 'test/actual/paths' ]
      ...
      <ul>
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/collections-categories2.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: collections-categories2.html
        this.pagename: collections-categories2.html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/collections-tags-2.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: collections-tags-2.html
        this.pagename: collections-tags-2.html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/assets.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: assets.html
        this.pagename: assets.html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/helpers.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: helpers.html
        this.pagename: helpers.html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/home.html
        this.absolute: 
        this.dirname:  test/actual/paths
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/html-helpers.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: html-helpers.html
        this.pagename: html-helpers.html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/no-layout.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: no-layout.html
        this.pagename: no-layout.html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/page.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: page.html
        this.pagename: page.html
        this.basename: page
        this.extname:  .html
        this.ext:      .html
        ...
        "this"
        ===============================
        this.dest:     test/actual/paths/simple3.html
        this.absolute: 
        this.dirname:  test/actual/paths
        this.filename: simple3.html
        this.pagename: simple3.html
